...
use App\Kafka\Handlers\PostCensorHandler;
use App\Kafka\Handlers\PostNotifyHandler;
...
return [
    ...
    'consumer_groups' => [
        'post-censor' => [
            ...
            'handler' => PostCensorHandler::class,
        ],

        'post-notify' => [
            'topics'  => ['posts'],
            'event_type' => 'post_created',
            'handler' => PostNotifyHandler::class,
        ],
    ],
    ...
    'partition' => env('KAFKA_PARTITION', 5),
     ...
     */
    'cache_driver' => env('KAFKA_CACHE_DRIVER', env('CACHE_DRIVER', env('CACHE_STORE', 'redis'))),
